...
export const BUILDINGS: Record<BuildingType, BuildingDef> = {
  ...
  BARRACKS: { name: 'Barracks', icon: '🎖️', cost: { ORE: 1, CRYSTAL: 1, ENERGY: 1 }, desc: 'REQUIRED to recruit on this planet — yields 1/2/4 troops at L1/L2/L3, costing 1⛏️ per troop', cardWeight: 6, cardColor: '#ff9e3d', short: 'recruit 1/2/4' },
  ...
  SILO: { name: 'Rocket Silo', icon: '🚀', cost: { ORE: 4, ENERGY: 2 }, desc: 'REQUIRED to attack — rockets launch only from Silo planets. Doubles rocket capacity per level (L1: 6 · L2: 12 · L3: unlimited). Adds +2 strike per level', cardWeight: 4, cardColor: '#ff9e3d', short: 'attack · 6/12/∞' },
